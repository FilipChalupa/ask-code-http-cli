...
Docker container that answers questions about the [background-configurator](https://github.com/kilomayocom/background-configurator) codebase using Gemini API. Designed for Slack Q&A via Home Assistant.
